...
export default function Section05() {
  ...
  return (
    <div className="flex lg:flex-row-reverse flex-col-reverse justify-between items-center gap-20 lg:gap-6 2xl:gap-12 py-12 md:py-24 px-4 md:px-6 xl:px-8 2xl:px-44 bg-white text-center lg:text-start">
